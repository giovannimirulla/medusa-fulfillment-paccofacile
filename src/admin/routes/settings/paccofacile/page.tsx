...
const FulfillmentProvidersPage = () => {
    ...
    useEffect(() => {
        ...
        const fetchAccountDetails = async () => {
            try {
                const response = await fetch('/paccofacile/account')
        ...
        const fetchCredit = async () => {
            try {
                const response = await fetch('/paccofacile/credit')
                const data = await response.json()
                setCredit(data)
            } catch (error) {
        ...
        const loadSetting = async (settingName: string): Promise<string | undefined> => {
            try {
            const res = await fetch(`/paccofacile/settings/${settingName}`)
            if (!res.ok) {
    ...
    const saveSetting = async (settingName: string, settingValue: string): Promise<void> => {
        ...
        try {
            ...
            await fetch(`/paccofacile/settings/${settingName}`, {
                method: "POST",
                headers: {
